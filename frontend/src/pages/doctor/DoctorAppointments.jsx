...
import { Calendar, Search, Clock, CheckCircle2, XCircle, FileText, User, Sparkles, Filter, ChevronRight } from 'lucide-react';
          ...
          <div className="flex items-center gap-3.5">
            ...
            <div>
              ...
              <p className="text-xs sm:text-sm text-slate-500 mt-0.5">
                Manage your clinical schedule, patient consultations, and update OPD visit statuses.
              </p>
            </div>
          </div>
        ...
        <div className="bg-white rounded-2xl border border-slate-200/80 shadow-xs overflow-hidden">
          {loading ? (
            <div className="p-16 text-center">
              ...
              <p className="mt-3 text-xs sm:text-sm font-medium text-slate-500">Loading consultation schedule...</p>
            </div>
            ...
            <div className="p-16 text-center">
              ...
              <p className="text-xs text-slate-500 mt-1 max-w-sm mx-auto">
                No consultations match your selected filter. Adjust the filter tabs or search terms above.
              </p>
            </div>
          ) : (
              ...
              <table className="w-full text-left border-collapse text-xs sm:text-sm">
                <thead>
                  <tr className="bg-slate-50/80 text-slate-500 font-semibold text-[11px] uppercase tracking-wider border-b border-slate-200/80">
                    ...
                    <th className="py-3.5 px-5">Chief Complaint / Symptoms</th>
                    ...
                    <tr key={app._id} className="hover:bg-slate-50/60 transition-colors">
                      <td className="py-3.5 px-5">
                        <div className="flex items-center gap-3">
                          <div className="w-9 h-9 rounded-xl bg-gradient-to-tr from-sky-100 to-teal-100 text-sky-800 font-bold text-xs flex items-center justify-center shrink-0">
                          ...
                          <div>
                            ...
                            <div className="text-[11px] text-slate-500">{app.patient?.phone || app.patient?.email}</div>
                          </div>
                        </div>
                      </td>
                      ...
                      <td className="py-3.5 px-5 text-slate-600 max-w-xs">
                        <p className="truncate text-xs">{app.reason || 'General Health Consultation'}</p>
                      </td>
                      <td className="py-3.5 px-5">
                        <span
                      ...
                      <td className="py-3.5 px-5 text-right">
                        <div className="flex items-center justify-end gap-1.5">
                          ...
                          <Link
                            to="/doctor/prescriptions"
                            className="p-1.5 text-slate-500 hover:text-sky-600 hover:bg-slate-100 rounded-lg transition-colors inline-flex items-center"
